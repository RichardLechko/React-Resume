...
const Currency = () => {
  ...
  return (
    <div className="flex justify-center items-center my-20 h-[50vh]">
      <div className="flex">
        <div className="flex flex-col ">
          <form className="flex flex-col">
            <div className="outline-1 outline-black outline-double mb-2 ">
              <input
                type="text"
                name="currency-startVal"
                id="currency-startVal"
                className="text-xl font-bold text-center p-[15px] border-r-2 border-black"
                value={firstCurrVal}
                onChange={(e) => setFirstCurrVal(e.target.value)}
              />
              <select
                className="text-xl font-bold text-center p-[15px]"
                name="currency-start"
                id="currency-start"
                value={startCurrency}
        ...
        <div className="flex-grow flex">
          <i
            id="flip-icon"
            className="rotate-90 hover:cursor-pointer text-[5rem]"
            onClick={handleFlip}
          >
            <IoRefresh />
          </i>
